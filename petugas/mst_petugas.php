...
<a href="?pilih=4.7&aksi=tambah" class="btn btn-primary"><span class='glyphicon glyphicon-plus'></span> Tambah</a> 
                    </span></h4>
...
?>
    	<tr>
            ...
            <?php $cinta=mysql_fetch_array(mysql_query("SELECT * from t_user where kode_petugas='$lagi' "));
             ?>
...
<label>Kode User</label>
 <input type="text" class="form-control" name="kode_user" size="54" value="<?php echo nomer("U","kode_user","t_user");?>" readonly"/>
</div>
<div class="form-group">
...
<div class="form-group">
<label>Telepon</label>
 <input type="text" class="form-control" name="telp" value="<?php echo $data2['no_telp'];?>"/>
</div>
<div class="form-group">
<label>Jenis Kelamin</label>
 <?php  
