  ...
  <div class="col-lg-12">
     ...
     <div class="row">
        ...
        $simpan=mysql_fetch_array(mysql_query("SELECT sum(besar_simpanan) as simpan from t_simpan"));
       	...
       	//$tabung=mysql_fetch_array(mysql_query("SELECT sum(besar_tabungan) as tabung from t_tabungan"));
       	//echo $tabung['tabung'];
          ...
          <div class="small-box">
            <div class="panel" style="border: 2px solid#5bc0de; ">
              ...
              <div class="panel-body">
               <span style="font-size:30px;"><?php echo 'Rp. '.number_format($pendapatan);//.' '.$tabung['tabung'].' '.$angsur['angsuran'].' '.$denda['denda']; ?></span>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-xs-10">
          ...
          <div class="small-box">
            <div class="panel" style="border: 2px solid#5bc0de; ">
              ...
              <div class="panel-body">
               <span style="font-size:30px;"><?php echo 'Rp. '.number_format($pengambilan);//.' '.$tabung['tabung'].' '.$angsur['angsuran'].' '.$denda['denda']; ?></span>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-xs-10">
          ...
          <div class="small-box">
            <div class="panel" style="border: 2px solid#5bc0de; ">
              ...
              <div class="panel-body">
               <span style="font-size:30px;"><?php echo 'Rp. '.number_format($sisapen);//.' '.$tabung['tabung'].' '.$angsur['angsuran'].' '.$denda['denda']; ?></span>
              </div>
            </div>
          </div>
        </div>
