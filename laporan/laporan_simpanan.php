...
?>
    	<tr>
			...
			<td align="center"><?php echo number_format($d['pokok']);?></td>
			...
			<td align="center"><?php echo number_format($e['wajib']);?></td>
			...
			<td align="center"><?php echo number_format($f['sukarela']);?></td>
...
<tr  class="info"><td colspan="3" align="center">Total</td>
  <td><?php $bu=mysql_fetch_array(mysql_query("SELECT sum(besar_simpanan) as besar_simpan from t_simpan where kode_anggota='$kode'")); echo number_format($bu['besar_simpan']);
  echo '</td>';?>
</tr>
</tbody>   
</table>
