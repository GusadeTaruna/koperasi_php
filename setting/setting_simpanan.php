...
<div class="row mt">
  <div class="col-lg-12">
     <div class="form-panel">
        ...
        <?php
         $am=mysql_query("select*from t_jenis_simpan");
...
<div class="form-group">
 ...
 <input type="text" class="form-control" name="besar_simpanan" size="54"/>
</div>
<div class="form-group">
...
<div class="form-group">
 <label>Jenis Simpanan</label>
 <input type="text" class="form-control" name="nama_simpanan" size="54" value="<?php echo $data2['nama_simpanan'];?>" readonly=""/>
</div>
<div class="form-group">
 <label>Besar Simpanan</label>
 <input type="text" class="form-control" name="besar_simpanan" size="54" value="<?php echo $data2['besar_simpanan'];?>"/>
</div>
<div class="form-group">
 <label>User Entri</label>
 <input type="text" class="form-control" name="u_entry" size="54" value="<?php session_start(); echo $_SESSION['kopname'];?>" readonly="">
