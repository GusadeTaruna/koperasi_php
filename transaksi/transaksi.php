...
<div class="row mt">
                <div class="col-lg-12">
                    ...
                    <input type="text" id="cari" style="width:230px;height:30px;" placeholder=" cari disini..."></span>
                 	</h4>
    ...
    <form action="transaksi/proses_transaksi.php?pros=simpan" method="post" id="form" name="mainform" onSubmit="validasiSimpan()">
        ...
        <div class="form-group">
            ...
            <select name="kode_jenis_simpan" class="form-control" id="kode_jenis_simpan" onChange="show(this.value)" class="required" title="Jenis Simpan harus diisi">
                <option value="nama_simpanan" selected="selected"> jenis simpanan </option>
        ...
        <div class="form-group">
            ...
            <input type="text" name="besar_simpanan" class="form-control" id="besar_simpanan" size="54"/>
        </div>
        <div class="form-group">
...
<div class="form-group">
    ...
    <select name="kode_jenis_pinjam" class="form-control" id="kode_jenis_pinjam" onChange="show3(this.value)" class="required" title="Jenis Pinjaman harus diisi">
                <option value="nama_pinjaman" selected="selected">pinjaman</option>
                <?php
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="besar_pinjaman" id="besar_pinjam" size="54" class="required" title="Besar Pinjaman harus diisi"/>
</div>
<div class="form-group">
...
<label for="kode_pinjam">Kode Pinjam</label>
     		<select name="kode_pinjam" class="form-control" id="kode_pinjam" onChange="show2(this.value)" class="required" title="Jenis Simpan harus diisi">
                <option value="kode_pinjam" selected="selected">pinjaman</option>
                <option value="<?php echo $_GET['kode_pinjam']; ?>"><?php echo $_GET['kode_pinjam']; ?></option>
            </select>
</div>
<div class="form-group">
<label for="tgl_pinjam">Tanggal Pinjam</label>
  <input id="tgl_pinjam" class="form-control" type="text" name="tgl_pinjam" size="54" readonly disabled/>
</div>
<div class="form-group">
<label for="besar_pinjaman">Besar Pinjam</label>
  <input type="text" class="form-control" name="besar_pinjam" id="besar_pinjam" value="" size="54" readonly disabled onFocus="startCalc();" onBlur="stopCalc();"/>
</div>
<div class="form-group">
<label for="lama_angsur">Lama Angsur</label>
  <input type="text" class="form-control" name="lama_angsuran" id="lama_angsuran" size="54" readonly disabled onFocus="startCalc();" onBlur="stopCalc();"/>
</div>
<div class="form-group">
<label for="besar_angsur">Angsuran</label>
  <input type="text" class="form-control" name="besar_angsur" id="besar_angsuran" size="54" readonly />
</div>
<div class="form-group">
<label for="sisa_pinjam">Angsuran Ke</label>
  <input type="text" class="form-control" name="angsuran_ke" id="angsuran_ke" size="54" />
</div>
<?php 	
...
<div class="row mt">
                <div class="col-lg-12">
                    ...
                    <span style="float:right;">
<?php 
$rino=mysqli_query($koneksi,"SELECT*FROM t_jenis_simpan");
$no=1;
...
<tr  class="info"><td colspan="3" align="center">Total</td>
  <td><?php $bu=mysqli_fetch_array(mysqli_query($koneksi,"SELECT sum(besar_simpanan) as besar_simpan from t_simpan where kode_anggota='$kode'")); echo $bu['besar_simpan'];
  echo '</td>';?>
</tr>
</tbody>   
</table>
